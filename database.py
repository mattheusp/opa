...
CREATE TABLE IF NOT EXISTS bot_config(
    ...
    main_img TEXT DEFAULT 'https://telegra.ph/file/133a40dd546f2de565d08.jpg',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@gringomdz',                               -- Username de atendimento
