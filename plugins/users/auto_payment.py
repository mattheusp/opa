        ...
        if rt == "PAGO":
           ## rt = "PAGO"
            ...
            await c.send_message(
                ADMIN_CHAT,
                f"<a href='https://t.me/gringomdz'>&#8204</a>💰 {mention} Adicionou <b>R${value}</b> de saldo\n\n<a href='https://t.me/gringomdz'>SUPORTE</a>",
            )
            mention = user.first_name
            await c.send_message(
                GRUPO_PUB,
                f"<a href='https://t.me/gringomdz'>&#8204</a>💰 {mention} Adicionou <b>R${value}</b> de saldo no bot\n\n<a href='https://t.me/gringomdz'>Suporte</a>",
            )
...
async def auto_pay(c: Client, m: Union[CallbackQuery, Message]):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="❮ ❮", callback_data="add_saldo")]
        ]
    )
...
⚠️ Caso não consiga efetuar o pagamento, chame o 👉 {get_support_user()}</b>""",
...
⚠️ Se não conseguir fazer pix automático, chame o: @gringomdz
"""
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🔕 já fiz o pagamento", callback_data="start"
                )
            ]
        ]
    )
